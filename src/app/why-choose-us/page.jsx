...
export default function WhyChooseUsPage() {
  ...
  return (
    <SiteLayout>
      ...
      <PageBanner title="Why Choose Us" subtitle="A simple process and reliable plumbing you can count on" />
      <section className="mx-auto max-w-7xl px-4 py-10 md:py-16">
        <div className="text-center mb-12">
          <p className="text-gold font-heading font-bold uppercase tracking-[0.2em] text-sm mb-2">Simple Process</p>
          <h2 className="font-heading text-2xl font-extrabold uppercase text-navy md:text-4xl">How It Works</h2>
